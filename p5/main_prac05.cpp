...
void display(void)
{
	...
	//glm::mat4 temp.at(2) = glm::mat4(1.0f); //Temp
	//glm::mat4 temp.at(2)2 = glm::mat4(1.0f); //Temp
	glm::mat4 model = glm::mat4(1.0f);		// initialize Matrix, Use this matrix for individual models
	std::vector<glm::mat4> temp = { glm::mat4(1.0f), glm::mat4(1.0f) , glm::mat4(1.0f) };
	...
	model = temp.at(2) = glm::translate(temp.at(2), glm::vec3(-6, 0, 0));
	model = glm::scale(temp.at(2), glm::vec3(4, 1, 1));
	projectionShader.setVec3("aColor", glm::vec3((float)119 / 255, (float)83 / 255, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //pie 1

	model = temp.at(2) = glm::translate(temp.at(2) = glm::mat4(1.0f), glm::vec3(0, 2.75, 0.0f));
	model = glm::scale(temp.at(2), glm::vec3(0.5, 0.5, 1));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, (float)183 / 255, (float)247 / 255));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //cuello

	model = temp.at(2) = glm::translate(temp.at(2), glm::vec3(0, 1.5, 0));
	model = glm::scale(temp.at(2), glm::vec3(1.5, 2.5, 1));
	projectionShader.setVec3("aColor", glm::vec3(1.0f, 0.0f, 0.0f));
	projectionShader.setMat4("model", model);
	glDrawArrays(GL_QUADS, 0, 24); //cabeza

	//hombro
	model = glm::translate(model = glm::mat4(1.0f), glm::vec3(2.5, 2, 0));
