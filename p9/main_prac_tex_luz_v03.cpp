...
unsigned int	t_norte,
				...
				t_poniente,
				t_bricks;
bool shader1 = true, shader2 =false, shader3 = false;

const char*  vs_file = "shaders/shader_texture_light_pos.vs";
const char* sf_file = "shaders/shader_texture_light_pos.fs";
...
void LoadTextures()
{
	...
	t_norte = generateTextures("Texturas/muro_norte.png", 1);
	t_sur = generateTextures("Texturas/muro_sur.png", 1);
	t_poniente = generateTextures("Texturas/muro_poniente.png", 1);
	t_oriente = generateTextures("Texturas/muro_oriente.png", 1);
...
void display(void)
{
	...
	if (shader2)
	{
		vs_file = "shaders/shader_texture_light_pos.vs";
		sf_file = "shaders/shader_texture_light_pos.fs"; //Positional
	}
	if (shader1)
	{
		vs_file = "shaders/shader_texture_light_dir.vs";
		sf_file = "shaders/shader_texture_light_dir.fs"; //Directional
	}
	if (shader3)
	{
		vs_file = "shaders/shader_texture_light_spot.vs";
		sf_file = "shaders/shader_texture_light_spot.fs"; //Spotlight
	}

	Shader lightingShader(vs_file, sf_file);
	...
	// material properties
	lightingShader.setFloat("material_shininess", 60.0f);
	...
	lightingShader.setInt("material_diffuse", t_bricks);
...
void my_input(GLFWwindow *window)
{
	...
	{
		shader1 = true;
		shader2 = shader3 = false;
	}
	if (glfwGetKey(window, GLFW_KEY_K) == GLFW_PRESS)
	{
		shader2 = true;
		shader3 = shader1 = false;
	}
	if (glfwGetKey(window, GLFW_KEY_L) == GLFW_PRESS)
	{
		shader3 = true;
		shader2 = shader1 = false;
	}
